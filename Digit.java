...
{
byte daysInAWeek=7;
short electricityBillPerMonth=340;
int salaryOfPresidentOfIndia=50000;
long lightyear=600000;
float massValueOfIron=55.845f;
double squarerootOf14=3.741657386d;
char f=102;
boolean bloodColorIsRed= true;
String train="I am a trainee in X-workz";
...
System.out.println(massValueOfIron);
